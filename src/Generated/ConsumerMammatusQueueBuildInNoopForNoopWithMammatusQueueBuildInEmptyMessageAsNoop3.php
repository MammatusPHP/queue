...
final class ConsumerMammatusQueueBuildInNoopForNoopWithMammatusQueueBuildInEmptyMessageAsNoop3 implements LifeCycleHandler
{
...
//        $this->logger->debug('Starting consumer: {serverName}', ['serverName' => self::NAME]);
        $this->promise = $this->consumer->setupConsumer(WorkerFactoryMammatusQueueBuildInNoopForNoopWithMammatusQueueBuildInEmptyMessageAsNoop3::create());
