...
final class ConsumerMammatusQueueBuildInNoopForNoopWithMammatusQueueBuildInEmptyMessageAsNoop2 implements LifeCycleHandler
{
...
//        $this->logger->debug('Starting consumer: {serverName}', ['serverName' => self::NAME]);
        $this->promise = $this->consumer->setupConsumer(WorkerFactoryMammatusQueueBuildInNoopForNoopWithMammatusQueueBuildInEmptyMessageAsNoop2::create());
