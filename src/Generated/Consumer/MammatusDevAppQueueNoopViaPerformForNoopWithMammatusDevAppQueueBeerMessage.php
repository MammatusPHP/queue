 ...
 */
#[Group(Type::Normal, 'queue-worker-noop-76e2ca56180c69ff378a13a7030add1b')]
final class MammatusDevAppQueueNoopViaPerformForNoopWithMammatusDevAppQueueBeerMessage implements LifeCycleHandler
{
    ...
    {
        return 'queue-worker-noop-76e2ca56180c69ff378a13a7030add1b';
    }

    public function start(): void
    {
//        $this->logger->debug('Starting consumer: {serverName}', ['serverName' => self::NAME]);
        $this->promise = $this->consumer->setupConsumer(WorkerFactory\MammatusDevAppQueueNoopViaPerformForNoopWithMammatusDevAppQueueBeerMessage::create());
