 ...
 */
#[Group(Type::Normal, 'queue-worker-noop-noop-3')]
final class MammatusDevAppQueueOHellNoViaProostForNoopWithMammatusDevAppQueueBeerMessageAsNoop3 implements LifeCycleHandler
{
...
//        $this->logger->debug('Starting consumer: {serverName}', ['serverName' => self::NAME]);
        $this->promise = $this->consumer->setupConsumer(WorkerFactory\MammatusDevAppQueueOHellNoViaProostForNoopWithMammatusDevAppQueueBeerMessageAsNoop3::create());
