...
final class MammatusDevAppQueueNoopViaPerformForNoopWithMammatusDevAppQueueBeerMessageAsNoop3 implements LifeCycleHandler
{
...
//        $this->logger->debug('Starting consumer: {serverName}', ['serverName' => self::NAME]);
        $this->promise = $this->consumer->setupConsumer(WorkerFactory\MammatusDevAppQueueNoopViaPerformForNoopWithMammatusDevAppQueueBeerMessageAsNoop3::create());
