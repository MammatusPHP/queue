...
final class MammatusDevAppQueueNoopViaPerformForNoopWithMammatusDevAppQueueBeerMessageAsNoop2 implements LifeCycleHandler
{
...
//        $this->logger->debug('Starting consumer: {serverName}', ['serverName' => self::NAME]);
        $this->promise = $this->consumer->setupConsumer(WorkerFactory\MammatusDevAppQueueNoopViaPerformForNoopWithMammatusDevAppQueueBeerMessageAsNoop2::create());
